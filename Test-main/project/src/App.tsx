        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="flex items-center space-x-3 mb-4">
                <div className="relative">
                  ...
                  <div className="w-8 h-8 relative">
                    {/* Box base */}
                    <div className="w-6 h-5 bg-gradient-to-br from-primary to-accent rounded-lg absolute bottom-0 left-1"></div>
                    {/* Box lid */}
                    <div className="w-6 h-1.5 bg-gradient-to-br from-primary to-accent rounded-t-lg absolute top-1.5 left-1"></div>
                    {/* Ribbon vertical */}
                    ...
                    <div className="absolute -top-0.5 left-1/2 transform -translate-x-1/2">
                      <div className="w-2 h-1.5 bg-gradient-to-br from-primary to-accent rounded-full"></div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-neutral-600">
                ...
                <li><a href="#" className="hover:text-primary transition-colors">Мобильное приложение</a></li>
          ...
          <div className="mt-8 pt-8 border-t border-neutral-200 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-neutral-600 hover:text-primary transition-colors text-sm">
