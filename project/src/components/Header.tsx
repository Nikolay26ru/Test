        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            <div className="relative">
              {/* Gift box with gradient */}
              <div className="w-10 h-10 relative">
                {/* Box base */}
                <div className="w-8 h-6 bg-gradient-to-br from-primary to-accent rounded-lg absolute bottom-0 left-1"></div>
                {/* Box lid */}
                <div className="w-8 h-2 bg-gradient-to-br from-primary to-accent rounded-t-lg absolute top-2 left-1"></div>
                {/* Ribbon vertical */}
                ...
                <div className="absolute -top-1 left-1/2 transform -translate-x-1/2">
                  <div className="w-3 h-2 bg-gradient-to-br from-primary to-accent rounded-full"></div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Поиск..."
                className="pl-10 pr-4 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none w-64"
              />
            </div>
            <button className="bg-gradient-to-r from-primary to-accent text-white px-4 py-2 rounded-lg hover:shadow-lg transition-all duration-200 flex items-center space-x-2">
