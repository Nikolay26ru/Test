          ...
          <div className="flex items-center space-x-2 pt-2">
            {!gift.isCompleted ? (
              <button
                ...
                className="flex-1 bg-gradient-to-r from-primary to-accent text-white py-2.5 px-4 rounded-lg hover:shadow-lg transition-all duration-200 font-medium hover:scale-[1.02] active:scale-[0.98]"
              >
                Поддержать
              </button>
            ) : (
            ...
            <button 
              className="p-2.5 border border-neutral-300 rounded-lg hover:bg-neutral-50 transition-all duration-200 hover:border-red-300 group"
