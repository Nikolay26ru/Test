        ...
        <div className="flex items-center space-x-3 mb-4">
          {isOwnProfile ? (
            ...
            <>
              <button
                onClick={onFollow}
                className={`flex-1 py-2.5 px-4 rounded-lg transition-all duration-200 flex items-center justify-center space-x-2 hover:scale-[1.02] ${
                  user.isFollowing
              ...
              <button className="p-2.5 border border-neutral-300 rounded-lg hover:bg-neutral-50 transition-all duration-200 hover:border-primary hover:scale-110">
